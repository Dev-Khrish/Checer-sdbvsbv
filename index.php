...
$bowner = "<a href='t.me/VorTexNetworkTeam'>[↯] 𝐕𝐨𝐫𝐭𝐞𝐱 </a>";
//$header = "ʙʏᴛᴇ ᴄᴏᴅᴇʀ";
...
//========[OWNER DATA]===//
  ...
  if (($userId == "6408116706") || ($userId == "6408116706"))
  {
    $role = "OWNER";
  }
if ($chatId != $userId)
...
//////////////////////////////
$sk = 'UarHqwem3kV7vMCdPdYAH4YkFG7EZZny8DhMbAOG8JVXuxz5hJ1y7gxkhQAhSEty600db9MdZUI';
